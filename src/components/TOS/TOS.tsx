    ...
    <>
      <div id='TOS'>
        <Typography variant="h4" gutterBottom>
            Let's Meet-Up Terms of Service and User License
        </Typography>
        <Typography variant="body1" gutterBottom>
            <p>This Let's Meet-up Terms of Service and User License ("TOS" or this “Agreement”) governs any access to and use of the applications, services and websites (collectively “Company Services”) offered or made available by Let's Meet-up ("Company" or “we/us”) at <a href='https://lets-meet-up.vercel.app/'>https://lets-meet-up.vercel.app/</a>, or through corresponding sites on social media outlets. This TOS is subject to modification from time to time as described below and You can review the most current version at any time at: <a href='https://lets-meet-up.vercel.app/tos'>https://lets-meet-up.vercel.app/tos</a>.</p>
        ...
        <Typography variant="body1" gutterBottom>
          ...
          <p>
            Notice of alleged copyright infringement or other legal notices regarding User Content appearing on the Site or Company Service shall be sent to <a href='mailto:jatin@linkxtr.app'>jatin@linkxtr.app</a>. Company reserves the right to remove, block or otherwise stop the Sharing of User Content alleged to be infringing or otherwise illegal without prior notice and at our sole discretion.
          </p>
          <Typography variant="h6" gutterBottom>
        ...
        <Typography variant="body1" gutterBottom>
          ...
          <p>
            YOU EXPRESSLY UNDERSTAND AND AGREE THAT, TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, COMPANY, AND ITS AFFILIATES, OFFICERS, DIRECTORS, EMPLOYEES, AGENTS AND LICENSORS, SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL OR EXEMPLARY DAMAGES, ARISING OUT OF OR IN CONNECTION WITH YOUR USE OF THE SITE, COMPANY SERVICES (INCLUDING LET'S Meet-Up APPLICATIONS), COMPANY MATERIALS, USER CONTENT, INFORMATION AND RESULTS AND OTHER CONTENT AND INFORMATION AVAILABLE THROUGH THE SITE OR COMPANY SERVICES, INCLUDING BUT NOT LIMITED TO, DAMAGES FOR LOSS OF PROFITS, GOODWILL, USE, DATA OR OTHER INTANGIBLE LOSSES (EVEN IF COMPANY HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES). IN NO EVENT WILL COMPANY'S (OR ITS AFFILIATES’, OFFICERS’, DIRECTORS’, EMPLOYEES’, AGENTS’ AND LICENSORS’) CUMULATIVE LIABILITY TO YOU EXCEED US $100.00, EXCEPT TO THE EXTENT SUCH LIMITATION IS NOT PERMITTED BY APPLICABLE LAW.
          </p>
          <p>
        ...
        <Typography variant="body1" gutterBottom>
          ...
          <ul>
            <li>(a) You own the computer or device on which You are using the Let's Meet-Up Website on, or have the authority to use the Let's Meet-Up Website on such computer or device</li>
            <li>(b) your use of the Company Services will not violate any local, state or federal laws that apply to You</li>
            <li>(c) Company is not causing the Let's Meet-Up Website to be used on your computer or device, but has provided the Let's Meet-Up Website to You, which You are using of your own volition</li>
